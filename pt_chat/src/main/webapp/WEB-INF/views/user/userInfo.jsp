...
<section style="margin-top: 50px;">
	<article>
		...
		<table>
			...
			<input type="hidden" size="30" name="email" value="${userInfo.email}">
				<tr>
				...
				<tr> 
					...
					<td>
						<input type="text" size="30" name="pwd" value="${userInfo.pwd}">
					</td>
				</tr>
				<tr>
					<td width="80">
					...
					<td>
						<input type="text" size="30" name="name" value="${userInfo.name}">
					</td>
				</tr>
				<tr>
					<td width="80">
			...
			<div class="btn">
						...
						<button type="button" onclick="location.href='main?id=${userDto.id}'">메인으로</button>
			</div>
		</form>
	</article>
</section>
